                     ...
                     columns: table => new
   {
           ...
           //
            ...
            migrationBuilder.CreateTable(
                ...
                Descripcion = table.Column<string>(type: "nvarchar(100)", nullable: true) // Cambiada a nvarchar(100) para coincidir con el script SQL
                 },
                 constraints: table =>
                     {
            table.PrimaryKey("PK__EstadosC__3214EC070A2D280B", x => x.IdEstado);
                });
